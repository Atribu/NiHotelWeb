...
const seoContent = {
  tr: {
    ...
    cityGuide: ["İzmit Şehir Rehberi | Teona Hotel", "Teona Hotel'den İzmit merkezi, otogar, alışveriş noktaları, Kartepe ve çevre ulaşım seçenekleri için pratik şehir rehberini inceleyin."],
    restaurant: ["Payidar Restaurant | Teona Hotel İzmit", "Teona Hotel bünyesindeki Payidar Traditional Restaurant'ın atmosferini, iletişim bilgilerini ve organizasyon olanaklarını keşfedin."],
  ...
  en: {
    ...
    cityGuide: ["Izmit City Guide | Teona Hotel", "Plan access from Teona Hotel to central Izmit, the coach station, shopping centres, Kartepe and nearby transport routes."],
    restaurant: ["Payidar Restaurant | Teona Hotel Izmit", "Discover the atmosphere, contact details and event options of Payidar Traditional Restaurant located at Teona Hotel."],
  ...
  de: {
    ...
    cityGuide: ["Stadtführer İzmit | Teona Hotel", "Planen Sie vom Teona Hotel aus Wege ins Zentrum von İzmit, zum Busbahnhof, zu Einkaufszentren, Kartepe und in die Umgebung."],
    restaurant: ["Payidar Restaurant in İzmit | Teona Hotel", "Entdecken Sie Atmosphäre, Kontakt und Veranstaltungsmöglichkeiten des Payidar Traditional Restaurant im Teona Hotel."],
  ...
  ru: {
    ...
    cityGuide: ["Путеводитель по Измиту | Teona Hotel", "Спланируйте маршруты от Teona Hotel к центру Измита, автовокзалу, торговым центрам, Картепе и окрестностям."],
    restaurant: ["Ресторан Payidar | Teona Hotel Измит", "Узнайте об атмосфере, контактах и возможностях мероприятий в Payidar Traditional Restaurant при Teona Hotel."],
