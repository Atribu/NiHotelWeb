...
const NibeautySection = () => {
  ...
  return (
    <div className='flex bg-center bg-cover bg-[#588a62] w-screen py-10 lg:py-16 items-center justify-center'>
      <div className='flex flex-col lg:flex-row items-center justify-around w-[90%] xl:w-[70%] max-w-[1400px] gap-[8%]'>
        <div className='flex flex-col items-start justify-center text-start text-white gap-2 lg:gap-4 w-[70%]'>
