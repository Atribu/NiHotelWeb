...
const NibeautySection = () => {
  ...
  return (
    <div className='flex bg-center bg-cover bg-[#588a62] w-screen py-10 lg:py-16 items-center justify-center'>
      <div className='flex flex-col-reverse lg:flex-row items-center justify-around w-[90%] xl:w-[70%] max-w-[1400px] gap-6 lg:gap-[8%]'>
        <div className='flex flex-col items-center text-center lg:items-start justify-center lg:text-start text-white gap-2 lg:gap-4 w-[70%]'>
            <h4 className="text-[20px] lg:text-[28px] font-['Cormorant_Garamond'] font-bold">{t("title")}</h4>
            <p className='text-[12px] lg:text-[14px] font-jost w-[80%]'>{t("text")}</p>
