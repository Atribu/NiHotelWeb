  ...
  return (
    <div className="relative max-w-screen mx-auto px-4 py-10">
      ...
      <div className="flex flex-col lg:grid lg:grid-cols-5 gap-4 items-center relative z-10">
        {/* Soldaki Sabit Resim */}
        <div className="relative h-[420px] lg:h-[500px] overflow-hidden shadow-md col-span-2">
          <Image src={leftStatic} alt="Static Left" fill className="object-cover" />
        </div>

        {/* Ortadaki Dönen Slider */}
        <div className="overflow-hidden shadow-md h-[440px] lg:h-[500px] col-span-2">
          <div
          ...
          >
            {slides.map(slide => (
              ...
              >
                ...
                {/* İçerik */}
                <div className="w-[100%] p-4 flex flex-col lg:flex-row justify-start items-start lg:justify-between">
                <div className="flex flex-col w-[62%] gap-2">
                <h3 className="text-lg font-semibold">{slide.title}</h3>
                <p className="text-sm text-gray-600 flex-1">{slide.description}</p>
                </div>
                  <div className="flex items-center justify-center space-x-4 mt-2 lg:w-[34%]">
