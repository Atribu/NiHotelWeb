    ...
    <section className="mb-[100px] flex justify-center lg:mb-[50px] lg:mt-[30px] lg:px-4 xl:mb-[65px] xl:mt-[40px] 2xl:mb-[80px] 2xl:mt-[45px] 3xl:mb-[100px] 3xl:mt-[60px] 4xl:mb-[130px] 4xl:mt-[75px] 5xl:mb-[200px] 5xl:mt-[120px]">
      <div className=" relative mt-[35px] w-[300px] xs:w-[390px] lg:mt-10 lg:w-[540px] xl:w-[620px] 2xl:w-[820px] 3xl:w-[920px] 4xl:w-[1250px] 5xl:w-[1850px]">
        ...
        <div className=" flex w-full justify-end px-4 lg:mt-[30px] lg:px-0 xl:mt-[45px] 2xl:mt-[55px] 3xl:mt-[60px] 4xl:mt-[95px] 5xl:mt-[135px]">
          <div className="cardClip h-[200px] w-[200px]  xs:h-[250px] xs:w-[230px] lg:h-[300px] lg:w-[295px] xl:h-[400px] xl:w-[340px] 2xl:h-[495px] 2xl:w-[445px] 3xl:h-[570px] 3xl:w-[485px] 4xl:h-[760px] 4xl:w-[675px] 5xl:h-[1140px] 5xl:w-[1015px]">
        ...
        <div className="mx-4 -mt-[75px] h-[110px] w-[180px] bg-orange-500  xs:-mt-[97.5px] xs:h-[150px] xs:w-[190px] lg:mx-0 lg:-mt-[120px] lg:h-[200px] lg:w-[310px] xl:-mt-[155px] xl:h-[190px] xl:w-[362.5px] 2xl:-mt-[185px] 2xl:h-[265px] 2xl:w-[485px] 3xl:-mt-[235px] 3xl:h-[300px] 3xl:w-[555px] 4xl:-mt-[315px] 4xl:h-[405px] 4xl:w-[747.5px] 5xl:-mt-[462.5px] 5xl:h-[610px] 5xl:w-[1090px]">
