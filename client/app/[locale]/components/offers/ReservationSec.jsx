...
<div className="flex flex-col border border-gray-200 px-7 py-4 shadow-sm gap-5 md:gap-8 font-jost text-[#24292C]">
      ...
      <button
        type="submit"
        className="w-full flex items-center justify-center gap-2 py-2 border border-gray-300 uppercase text-[13px] font-jost font-medium hover:bg-gray-100 transition"
      >
        <span>Book Now</span>
