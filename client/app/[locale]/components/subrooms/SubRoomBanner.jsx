...
const RoomsBanner = ({header,m2,person,view, image}) => {
  return (
    ...
    <div className='flex h-full w-full lg:w-[42%] justify-center items-end md:items-center bg-[linear-gradient(268deg,rgba(255,255,255,0.9)_31.52%,rgba(255,255,255,0)_93.61%)] z-[100]'>
    <div className="flex flex-col gap-[34px] 2xl:gap-[24px] md:gap-10 xl:w-[80%] h-auto text-[#11131d] text-center justify-center items-center mb-[20%] mt-[16%] md:mb-[20px] lg:mb-0 ">
      <h2 className='font-marcellus text-[28px] md:text-[30px] lg:text-[36px] leading-[20px] -tracking-[0.88px] font-normal 2xl:mb-4 uppercase font-serif'>{header}</h2>
      <div className='flex min-w-[220px] w-[70%] h-[1px] bg-[#11131d]'></div>
      <div className='flex gap-[18px] items-center justify-center text-[14px] lg:text-[16px] '>
