...
const RoomsBanner = ({header,m2,person,view, image}) => {
  return (
    ...
    <div className='flex h-full w-full lg:w-[42%]  lg:justify-center items-end md:items-center bg-[linear-gradient(0deg,#FFF_7.88%,rgba(255,255,255,0)_50%)] lg:bg-[linear-gradient(268deg,rgba(255,255,255,0.9)_31.52%,rgba(255,255,255,0)_93.61%)] z-[100]'>
