...
const RoomsBanner = () => {
  ...
  return (
    <div className='flex h-[88vh] w-screen lg:h-screen lg:items-end md:items-center lg:justify-end bg-center bg-cover justify-center items-center relative' >
       <Image
        src={imgbanner}
        alt="rooms"
        fill
    ...
    <div className="flex flex-col gap-3 md:gap-[20px] lg:gap-2 w-full lg:w-[80%] h-auto text-[#11131d] text-center justify-center items-center lg:mt-[16%] mb-[15%] md:mb-10">
      <h2 className="font-['Cormorant_Garamond'] text-[48px]  lg:text-[36px] uppercase lg:capitalize leading-[20px] -tracking-[0.88px] mb-[75%] md:mb-[0px] 2xl:mb-4 font-bold">{t("rooms")}</h2>
